    ...
    >
        ...
        >
          <div
            className={`max-w-[80%] p-3 rounded-2xl transition-all duration-200 ${
              message.isUser
                ? 'bg-gray-900 text-white animate-fade-in backdrop-blur-sm bg-opacity-90'
                : 'bg-white text-gray-900 border border-gray-200 animate-fade-in backdrop-blur-sm bg-opacity-95'
            }`}
          >
      ...
      {aiTyping && (
        <div className="flex justify-start animate-fade-in">
          <div className="bg-white text-gray-900 border border-gray-200 p-3 rounded-2xl backdrop-blur-sm bg-opacity-95">
